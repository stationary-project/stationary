...
<body class="animsition">
    ...
    <div class="container m-b-40">
        <div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
            ...
            <a href="profile.php" class="mtext-80 cl8 hov-cl1 trans-04">
                Profile
                <i class="fa fa-angle-right m-l-9 m-r-10" aria-hidden="true"></i>
            </a>
    ...
    <section class="sec-product bg0 p-t-10 p-b-50">
        <div class="container">
            <div class="row">
                <div class="col-md-5  m-lr-auto m-b-50">
                    <div class="bor10 p-lr-30 p-t-30 p-b-40 m-r-80 m-lr-0-xl p-lr-15-sm bg2" style="border-radius: 5px !important">
                        <h3 class="mtext-109 cl2 p-b-30">Details for Order <br> Number: <?= $billNum ?></h3>
                        <h3 class="stext-105 cl5 "> <b>Billed for:</b> <?= $orderDetails[0]['f_name'] . " " . $orderDetails[0]['l_name'] ?></h3>
                        <h3 class="stext-105 cl5 "><b>Email:</b> <?= $orderDetails[0]['email'] ?> </h3>
                        <h3 class="stext-105 cl5 "><b>Phone:</b> <?= $orderDetails[0]['phone'] ?> </h3>
                        <h3 class="stext-105 cl5 "><b>Billing Address:</b> <?= $orderDetails[0]['address'] ?> </h3>
                        <h3 class="stext-105 cl5 "> <b>Total Price:</b> <?= $orderDetails[0]['total_price'] ?> JOD</h3>
                    </div>
                </div>

                <div class=" col-md-7 m-lr-auto m-b-50">
